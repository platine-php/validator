...
use Platine\Validator\Rule\NotMatches;
use Platine\Dev\PlatineTestCase;

/**
 * NotMatches validation rule class tests
 *
 * @group core
 * @group validator
 * @group rule
 */
class NotMatchesTest extends PlatineTestCase
{
    ...
    {
        return array(
            array('age', 'yes', 'yes', false),
            array('age', 'no', 'yes', true),
        );
    }
}
